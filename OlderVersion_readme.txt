...
V1: rf_1 
Trained on full data. Just for the purpose of setting things up, not very accurate

V2: rf_2
Recommended model, trained on whole data. Very accurate.

V3: rf_3
Finetuned large model, trained on whole data. Most accurate. Not recommended because of the size
